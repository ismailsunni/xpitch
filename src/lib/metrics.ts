...
export const METRIC_SECTIONS: MetricSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'hrZones', term: 'HR zones', desc: 'Time spent in each zone (Z1 recovery → Z5 max), defined as a percentage of your reference max HR.' },
      { key: 'recoveries', term: 'Recovery periods', desc: 'Times your heart rate dropped noticeably while you weren’t moving.' },
